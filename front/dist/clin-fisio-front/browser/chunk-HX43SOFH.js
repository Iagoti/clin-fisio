...
var UsuarioService = class _UsuarioService {
  ...
  obterPorId(id) {
    return this.http.get(`${environment.apiUrl}/usuario/${id}`).pipe(timeout(HTTP_TIMEOUT_MS));
  }
  salvar(body) {
    return this.http.post(`${environment.apiUrl}/usuario`, body).pipe(timeout(HTTP_TIMEOUT_MS));
  }
  atualizar(id, body) {
    return this.http.put(`${environment.apiUrl}/usuario/${id}`, body);
  }
  excluir(id) {
...
//# sourceMappingURL=chunk-HX43SOFH.js.map
